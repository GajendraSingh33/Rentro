...
let AvailabilityModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([availability_entity_1.Availability, pg_listing_entity_1.PGListing])],
    ...
    let _classThis;
    var AvailabilityModule = _classThis = class {
    };
